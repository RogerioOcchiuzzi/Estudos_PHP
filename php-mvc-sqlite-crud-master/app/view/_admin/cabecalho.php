...
<head>
    ...
    <title><?php if (isset($cfg['site'])) { echo $cfg['site'] . ' - Admin'; } else { echo 'PHP MVC - Admin'; } ?></title>
    ...
    <div class="dash">
        <div class="dash-nav dash-nav-dark">
            <header>
                ...
                <a href="<?php echo URL; ?>admin" class="spur-logo"><i class="fas fa-bolt"></i> <span class="truncate"><?php if (isset($cfg['site'])) { echo $cfg['site']; } else { echo 'PHP MVC'; } ?></span></a>
            </header>
        ...
        <div class="dash-app">
            <header class="dash-toolbar">
                ...
                <div class="tools">
                    ...
                    <a href="https://gitlab.com/sistematico/php-mvc-sqlite-crud" target="_blank" class="tools-item">
